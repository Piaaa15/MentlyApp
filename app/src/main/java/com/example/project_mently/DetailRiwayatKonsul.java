...
public class DetailRiwayatKonsul extends RecyclerView.Adapter<DetailRiwayatKonsul.HasilKonsulViewHolder> {

    private List<Konsul> hasilKonsulList;
    private Context parentContext;

    public DetailRiwayatKonsul(List<Konsul> hasilKonsulList, Context parent) {
